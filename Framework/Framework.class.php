...
class Framework
{
    ...
    private static function initPath(){
        defined('DS') or define('DS','/');   //定义目录分隔符,"/"
        ...
        defined('COMMEN_PATH') or define('COMMEN_PATH',PUBLIC_PATH.'commen'.DS); //commen的目录
...
//以下常量的值会随着用户访问的平台和控制器来确定.
        ...
        defined('CURRENT_VIEW_PATH') or define('CURRENT_VIEW_PATH',VIEW_PATH.$p.DS.$c.DS); //正在访问当前View在哪个平台的路径.
    }
    ...
    private static  function initMapping(){
        ...
        $GLOBALS['map'] = array(
            ...
            'Base'=>TOOLS_PATH.'Base.class.php',
            'Captcha'=>TOOLS_PATH.'Captcha.class.php',
            'CaptchaYunSuan'=>TOOLS_PATH.'CaptchaYunSuan.class.php'
        );
    }
    ...
    private static function initFunctions(){
        require TOOLS_PATH."functions.php";
    }
